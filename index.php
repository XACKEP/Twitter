			...
			<div class="row mt-2">
				...
				<div class="col-3 pl-0 bg-white mr-3">
					...
					<div class="col-12 mt-5 pl-2">
						...
						<div>
						<?php  
						$connects = mysqli_connect('127.0.0.1', 'root', '', 'sasha_pn_10');
				...
				<div class="col-5 pl-2 bg-white mr-3">
					<div class="col-12">
						<form method="POST" action="insert.php">
									...
									<button style="background:#00ff33;border-radius:10px;">Твитнуть</button>
								</form>
						<?php $connect = mysqli_connect('127.0.0.1', 'root', '', 'sasha_pn_10') ;
						...
						<div class="row">
							...
							<form action="bazik.php" method="POST">
								...
								<button style="background:red;border-radius:10px;">Delete</button>
							</form>
							<div></div>
							<form action="change.php" method="POST" style="display:block">
								...
								<?php echo '<button style="background:blue;border-radius:10px">Update</button>' ?>
							</form>
						</div>
